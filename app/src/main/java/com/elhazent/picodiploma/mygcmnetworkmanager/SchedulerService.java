package com.elhazent.picodiploma.mygcmnetworkmanager;
...
public class SchedulerService extends GcmTaskService {
    ...
    private final String APP_ID = "c0c00bfb30f28736dfdedc2eea78bdef";
    ...
    private void showNotification(Context context, String title, String message, int notifId){
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context).setContentTitle(title).setSmallIcon(R.drawable.ic_replay_30_black_24dp).setColor(ContextCompat.getColor(context, android.R.color.black)).setVibrate(new long[]{1000,1000,1000,1000,1000}).setSound(alarmSound);
